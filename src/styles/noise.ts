...
import { ThemeNoiseEffect } from '../themes/types'

export const gradientFilled: Record<keyof ThemeNoiseEffect, string> = {
...
export const colorFilled: Record<keyof ThemeNoiseEffect, UniformNoiseEffect> = {
...
export function getPlainNoiseEffectCss(color: keyof ThemeNoiseEffect) {
  return css`
    position: relative;
...
export function getGradientNoiseEffectCss(color: keyof ThemeNoiseEffect) {
  return css`
    mask-image: ${SVGMask};
